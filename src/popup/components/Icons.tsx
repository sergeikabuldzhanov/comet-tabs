...
export const PinIcon: React.FC<IconProps> = ({ className = "h-4 w-4" }) => (
  <svg
    className={className}
    aria-hidden="true"
...
export const PinIndicatorIcon: React.FC<IconProps> = ({
...
export const AudioIcon: React.FC<IconProps> = ({
  className = "h-4 w-4 fill-primary animate-pulse",
}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path d="M13.829 7.172a.75.75 0 0 0-1.061 1.06 2.5 2.5 0 0 1 0 3.536.75.75 0 0 0 1.06 1.06a4 4 0 0 0 0-5.656Z" />
  </svg>
);

export const MutedIcon: React.FC<IconProps> = ({
  className = "h-4 w-4 fill-base-content/70",
}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 20 20"
